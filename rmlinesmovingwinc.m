...
%JC, this is to ensure that all samples are kept in case that there is a non-full window at the end, this will only work on vectors, not [N x C] matrices
datac=[datac;data(numel(datafit)+1:end)];
if strcmp(plt,'y');

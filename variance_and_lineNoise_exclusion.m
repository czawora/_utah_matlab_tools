function variance_and_lineNoise_exclusion(varargin)
    ...
    readme = ['this lfp.mat file, generated ' sprintf('%s', createdDate) ', contains the following fields:' newline newline ...
              ...
              '     jackTableUsed        - just the jacksheet for the channels incorporated into this lfpStruct. this table can be used to go back and forth between original and new channel names' newline ...

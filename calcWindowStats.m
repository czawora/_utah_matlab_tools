function calcWindowStats(data_mat, sampling_freq, output_fpath, chan_names)
    ...
    window_move_num = floor(sample_window_size/1);
    ...
    save(output_fpath, 'hist_edges', 'hist_n', 'quantile_mats', 'mean_mats', 'std_mats', 'rms_mats', 'chan_names', 'start_windows', 'sampling_freq', 'sample_window_size', 'ms_window_size', 'samples_per_sec', 'num_data_samples', 'quantile_cutoffs');

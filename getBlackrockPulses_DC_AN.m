function pulses = getBlackrockPulses_DC_AN(varargin)
    ...
    if ~isequal(nev_fpath, '') && exist(nev_fpath, 'file')
        ...
        pulses.din1 = getBlackRockPulsesDC(NEVdata, 9);
        pulses.din2 = getBlackRockPulsesDC(NEVdata, 10);
        pulses.din3 = getBlackRockPulsesDC(NEVdata, 11);
        pulses.din4 = getBlackRockPulsesDC(NEVdata, 12);
